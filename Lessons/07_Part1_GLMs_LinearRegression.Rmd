...
want red line to be as flat as possible
...
dashed line is normal distribution
...
fitted values on the x, compared with square of standardized residuals, looking for symmetry for red line
...
# must eliminate the 0s to transform it into a log;l transforming just irradiance, not depth
...
irradiancebydepth2 <- 
  ...
  scale_y_log10() + # this one transforms the y value into a log
  geom_point() 
...
irradiancebydepth2 <- 
    ...
    geom_smooth(method = 'lm', se = FALSE, color = "black")#no confidence interval showing now with this command
print(irradiancebydepth2)
...
corrplot(PeterPaulCorr, method = "ellipse") # looks super cool! comparing variables
corrplot.mixed(PeterPaulCorr, upper = "ellipse") # print upper diagonal only
```
