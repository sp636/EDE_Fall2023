...
O3.density <-
  ...
  geom_density(alpha = 0.5)+ #for changing the transparency
  scale_fill_manual(values = c("darkgreen", "darkblue")) +
  labs( x = "Ozone AQI Value", y = "Density", fill = "") #could be "Year" - label for legend
print(O3.density)
...
Pm2.5 linear_regression <-
  lm(EPAair, PM2.5 ~ Ozone)
# look at summary and the adjusted r squared; only explains 13%, need to add more variables
...
# the narrower the stronger the correlation
# correlation of the latitude or month, we don't care about the signal of the correlation
...
OzonebyALL.regression <- lm(data = EPAair, )
#WANT A LOW AIC
