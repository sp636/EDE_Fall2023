...
# need to skip 30 lines in this one
#Set the URL
...
# read it from the cloud
# skip to line 30, separated by a tab \t
...
# data will be pulled in as a text; use as.numeric (in the ppt) and gsub command
```
