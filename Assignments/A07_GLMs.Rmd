...
#creating a new processed data set that is filtered to be only July, have certain columns, and be complete cases.
NTL.LTER.processed <-
  NTL.LTER.raw %>%
...
> Answer: Yes, there is significant difference in the mean temperature among the lakes. The p value is less than 0.05 so we reject the null hypothesis that all the mean temperatures among the lakes are the same.
