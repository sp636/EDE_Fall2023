...
> Answer: I have no experience with R and Git before this course. I have done some data visualization with Excel and a little on Power Bi, mostly making charts and analyzing trends in small data sets. I have taken a data visualization graduate level course before.

2. Are there any components of the course about which you feel confident?

> Answer: I am somewhat confident in the data visualization component of the course.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I am a little anxious about the data wrangling, time series analysis, and linear models components.
...
> Answer: https://github.com/sp636/EDE_Fall2023
